...
class UploadKnowledgeBaseExported extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:upload-knowledge-base-exported';
            ...
            if (!empty($gBaseById['id'])) {
                ...
                if ($KnowledgeBaseExported->count() > 0) {
                    foreach ($KnowledgeBaseExported as $item) {
                        ...
                        try {
                            $url = "https://rfp.hook.app.br/v1/datasets/".$bundle->agent->knowledge_id_hook."/document/create-by-file";
