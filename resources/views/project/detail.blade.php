            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    response.data.forEach(record => {
                        ...
                        let projectDelete = "{{ route('project.remove', ':id') }}".replace(':id', recordId);
                        let projectExport = "{{ route('project.export', ':id') }}".replace(':id', recordId);
                        ...
                        if (record.status === 'não enviado') {
                            ...
                            btnEdit = `<a href="${projectRecords}" style="margin: 0px; float:left;">
                                        ...
                                        <form action="${projectDelete}" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir este produto?');" style="margin: 0px; float:left;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" style="width: 17px; text-align: center; text-transform: uppercase; font-weight: bold; font-size: 13px; margin: 8px;">
                            ...
                            btnEdit = `<a href="${projectAnswer}" style="margin: 0px; float:left;">
                                    ...
                                    <a href="${projectExport}" style="margin-top: 5px; float:left;">
                                        <button type="submit" style="width: 17px; text-align: center; text-transform: uppercase; font-weight: bold; font-size: 13px; margin: 8px;">
