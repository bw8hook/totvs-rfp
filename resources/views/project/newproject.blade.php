<x-app-layout>
    ...
    <div class="flex flex-col">
        ...
        <div class="w-full max-w-md mx-auto justify-center items-center flex flex-column" style="width: 85vw; min-height: 73vh; max-width: 90%;">
                ...
                <x-title-component :showButton="false" componentType="edit" titleDescription="Confirme as informações:">Enviar RFP</x-title-component>
                ...
                <div class="bg-white rounded-lg shadow-md p-8 w-full" style=" margin-bottom: 100px; position:relative;">
                    ...
                    <a href="" id="downloadButton" target="_blank" class="px-4 py-2" style="display: none;
    background-color: #4CAF50;
    width: 406px;
    height: 58px;
    border-radius: 10px;
    color: white;
    box-shadow: 0px 19px 34px -20px #43BBED;
    margin-left: 503px;
    margin-top: 40px;
    text-align: center;
    line-height: 40px;">Baixar Arquivo Respondido</a>
                </div>
