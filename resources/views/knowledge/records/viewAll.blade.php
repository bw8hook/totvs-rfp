<x-app-layout>
    <div class="" style=" padding-bottom: 130px;">
        <div class="max-w-full mx-auto">
            ...
            <div id="titleComponent_KnowledgeBase" style=" padding-top: 20px; min-height: 85px; height: auto; justify-content: space-between; align-items: flex-start;" class="text-lg font-bold flex items-center justify-between w-full px-4 space-x-2 relative" >  
                <div class="block" style="width: 80%;">    
                    <div class="flex" style="width: 100%; margin-top: 6px;">
                    <img src="{{ asset('icons/base_conhecimento.svg') }}" alt="Upload Icon" style="height: 33%; padding-right: 18px;">
                        <span style="margin-top: 3px;">Busca de Requisitos na base de conhecimento</span>
                    </div>
            ...
            <div id="BlocoLista">
                ...
                <div class="bloco_info_filter_records">
                    <div>
                        <h2>Busca de Requisitos</h2>
                        <h4>Verifique cada item enviado. Para facilitar a sua busca de requisitos, escolha os filtros abaixo através de palavras-chave, classificação e linha de produto.</h4>
                    </div>
                ...
                <div id="ModalReferencia">
                    <div class="content">
                        ...
                        <div class="Title">
                            ...
                            <h2>Dados da Base de Conhecimento desse Requisito</h2>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        function fetchUsers(url = "{{ route('knowledge.recordsFilter') }}", append = false) {
            $.ajax({
                url: url,
                method: 'GET',
                        ...
                        //response.ReferenciasBanco.forEach(record => {
                            ...
                            rows += `
                                    <div class="Referencia">
                                        <h2>ID REQUISITO: <a href="${urlKnowledge}" target="_blank" class="idrequisito">${response.id_record}</a></h2>
                                        <div class="list">
                                            <div class="processoList">
                                                <div class="labelProcesso">Processo</div>
                                                <div class="textoProcesso">${response.processo} </div>
                                            </div>
                                            <div class="processoList">
                                                <div class="labelProcesso">Subprocesso</div>
                                                 <div class="textoProcesso">${response.subprocesso ? response.subprocesso : '-'}</div>
                                            </div>
                                            <div class="processoList">
                                                <div class="labelProcesso">Descrição do Requisito</div>
                                                <div class="textoProcesso">${response.requisito}</div>
                                            </div>
                                            <div class="processoList">
                                            ...
                                            <div class="processoList">
                                                ...
                                                <div class="textoProcesso">${response.bundles[0].bundle}</div>
                                            </div> 

                                            <div class="processoList">
                                                <div class="labelProcesso">Nome - Base de Conhecimento</div>
                                                <div class="textoProcesso">${response.knowledge_base.name}</div>
                                            </div> 
                                            <div class="processoList">
                                                <div class="labelProcesso">Data - Base de Conhecimento</div>
                                                <div class="textoProcesso">${response.knowledge_base.rfp_date}</div>
                                            </div> 
                                             <div class="processoList">
                                                <div class="labelProcesso">Status - Base de Conhecimento</div>
                                                <div class="textoProcesso">${response.knowledge_base.status}</div>
                                            </div> 
