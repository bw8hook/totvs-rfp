                    ...
                    response.data.forEach(bundle => {
                        ...
                        rows += `
                            <tr class="listaTabela">
                              <td style="width:10%;">#${bundle.bundle_id}</td>
                                <td style="width:60%; text-align:left;">${bundle.bundle}</td>
                                <td style="width:20%; text-align:center;">${formattedDate}</td>
                                <td style="width:10%; text-align:center; position:relative; display:flex;">
                                    <a class="btn_edit_row" href="/bundles/edit/${bundle.bundle_id}" style="margin: -6px 10px;;">
