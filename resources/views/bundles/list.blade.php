                    ...
                    response.data.forEach(bundle => {
                        rows += `
                            <tr class="listaTabela">
                                <td style="width:50%;">${bundle.bundle}</td>
                                <td style="width:20%; text-align:center;">${bundle.created_at}</td>
                                <td style="width:17%; text-align:center; position:relative;">
                                    ...
                                    <a href="/edit-bundle/${bundle.bundle_id}" class="btn_edit_row">
