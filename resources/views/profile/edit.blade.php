    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                @if (Auth::user()->role == "admin" || Auth::user()->id == 14)
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#ia" type="button" role="tab" aria-controls="profile" aria-selected="false">Inteligência Artificial</button>
                    </li>
                @endif
                <!-- <li class="nav-item" role="presentation">
            ...
            <div class="tab-content p-4 sm:p-8 bg-white shadow sm:rounded-lg" style="margin-top: 0px; border-top-left-radius: 0px; border-top-right-radius: 0px;" id="myTabContent">
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                    @include('profile.partials.update-token-form')
                </div>
                <div class="tab-pane fade" id="ia" role="tabpanel" aria-labelledby="contact-tab">
                    @include('profile.partials.ia-form')
                </div>
        </div>
